...
def parse_cdp_neighbors(command_output):
    ...
    for line in command_output.split('\n'):
        ...
        if '>' in line:
            ...
            host, begin_intf_dev, end_intf_dev, *other, begin_intf_host, end_intf_host = columns
            result[(device, begin_intf_dev + end_intf_dev)] = (host, begin_intf_host + end_intf_host)
    return result
