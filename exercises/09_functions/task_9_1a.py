...
def generate_access_config(intf_vlan_mapping, access_template, psecurity=None):
    ...
    for comm in psecurity:
        result.append(comm)
    return result

access_list_1 = generate_access_config(access_config, access_mode_template)
print(access_list_1)

print('-' * 40, '\n')

access_list_2 = generate_access_config(access_config, access_mode_template, psecurity=port_security_template)
print(access_list_2)